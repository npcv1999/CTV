    ...
    {/* <StatusBar barStyle={"dark-content"}></StatusBar> */}
      ...
      <View style={styles.tab}>
        ...
        style={[styles.button, state ===0 &&{borderBottomColor:'blue'}]}>
          <Text style={[styles.btnText, state===0 &&{color:'blue'}]}>ĐĂNG NHẬP</Text>
        </TouchableOpacity>
        <TouchableOpacity 
        onPress={()=> setState(1)}
        style={[styles.button, state ===1 &&{borderBottomColor:'blue'}]} >
          <Text style={[styles.btnText, state===1 && {color:'blue'}]}>ĐĂNG KÝ TÀI KHOẢN</Text>
        </TouchableOpacity>
      </View>

      <View style={styles.wrapper}>
        {state===0 && (<Login></Login>)}
        {state===1 && (<Register></Register>)}
          <View style ={styles.footer}> 
            ...
            <View style={styles.btnAcc}>
              <TouchableOpacity>
                <ButtonIcon icon="google" color="#ff1414"></ButtonIcon>
              </TouchableOpacity>
              <TouchableOpacity style={styles.btnAcc}>
                <ButtonIcon icon="facebook" color="#4d79ff"></ButtonIcon>
              </TouchableOpacity>
            </View>
          </View>
      </View>
